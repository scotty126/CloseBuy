...
// Landing point for the Google/Apple redirect (brief §3.1b) — the API
// hands off tokens via a URL fragment (never a query param or response
// body, since this is a full-page browser redirect, not an API call the
// client made directly) and this page turns that into a real session.
function OAuthCompleteInner() {
  ...
  useEffect(() => {
    ...
    save({
      accessToken,
      refreshToken,
      user: { id: "", role: "customer", email: null, emailVerifiedAt: null, phone: null, phoneVerifiedAt: null },
    });
